...
\begin{tikzpicture}
    ...
    % esges
    \draw [edge] (vM01.north) ..controls ($(vM01.north) + (0,1.5)$) and ($(vM05.north) + (0,1.5)$) .. (vM05.north);
    \draw [edge] (vM02.north) ..controls ($(vM02.north) + (0,0.5)$) and ($(vM03.north) + (0,0.5)$) .. (vM03.north);
    \draw [edge] (vM04.north) ..controls ($(vM04.north) + (0,1.0)$) and ($(vM06.north) + (0,1.0)$) .. (vM06.north);
  \end{tikzpicture}
}
